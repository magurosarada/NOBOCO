      ...
      <div className="mx-auto container rounded-md fixed bg-white left-0 top-0">
        ...
        <div className="flex md:flex-row flex-col">
          <div className="md:w-3/5 w-full border text-center pb-20">
            ...
            <button className="border rounded-md  w-14 h-14 mt-2"><img src="/add.svg" alt="" className="w-full h-full"/></button>
          </div>
          <div className="md:w-2/5 w-full border">
            ...
            <textarea name="" id="" placeholder="本文を入力"rows="6" className="w-full  mt-3"></textarea>
          </div>
        </div>
      </div>
  </div>
