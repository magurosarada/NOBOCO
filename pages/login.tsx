      ...
      <div className="mx-auto">
        <div className=" py-10 flex flex-col justify-center  md:w-3/5 mx-auto md:rounded-full">
          ...
          <div className="mt-5 flex flex-col justify-center">
            <Button
              Icon={FaGoogle}
              className="h-12 rounded-full w-4/6 mx-auto text-white px-2 py-1 flex border-none items-center  bg-[#dc4e40] "
            ...
            <Button
              Icon={FaTwitter}
              className=" h-12 mt-5 rounded-full   w-4/6 mx-auto px-2 py-1 flex text-white border-none  bg-[#1DA1F2]"
