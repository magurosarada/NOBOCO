      ...
      <div className="mx-auto">
        <div className=" py-10 flex flex-col justify-center bg-white md:w-3/5 mx-auto md:rounded-full">
          ...
          <div className="mt-5 flex flex-col justify-items-center">
            <div>
              <button
                className="border-2 h-12 rounded-full w-full md:w-3/5 mx-auto bg-white border-black border-solid hover:bg-gray-100"
            ...
            <div>
              <button className="border-2 h-12 mt-5 rounded-full w-full md:w-3/5 mx-auto bg-white border-black border-solid hover:bg-[#06c755]">
                LINEアカウントで登録
              </button>
            </div>
          </div>
